...
//          $this->success('请求成功');
    ...
    public function getNewsList() {
        try {
            ...
            $list = News::where(['status' => 1, 'lang' => $this->request->header('lang')])
                ->field('title, abstract, author, image, link, FROM_UNIXTIME(news_time) AS news_time')
                ->page($page, $pageSize)
