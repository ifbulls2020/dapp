<template>
    <div class="van-overlay" data-v-51fd882a="" style="z-index: 2514;" v-if="value">
        <div class="join-popup van-popup van-popup--center" data-v-51fd882a="" style="z-index: 2515;">
            <div data-v-51fd882a="">
                <svg xmlns="http://www.w3.org/2000/svg" @click="change(false)" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--fluent close" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="fluent:dismiss-24-regular" data-v-51fd882a="">
                    <g fill="none">
            ...
            <div class="popup-content" data-v-51fd882a="">
                <img src="../assets/static/image/icon_join_key.6d756ca8.svg" alt="" class="img-join" data-v-51fd882a="">
                <div class="join-title ff_InterMedium" data-v-51fd882a="">{{$t('key169')}}</div>
                <div class="submit-btn ff_NunitoBold" data-v-51fd882a="" @click="joinApprove">{{$t('key28')}}</div>
                <div class="tips" data-v-51fd882a="">{{$t('key170')}}</div>
            </div>
        </div>
    </div>
</template>
