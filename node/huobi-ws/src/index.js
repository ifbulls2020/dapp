...
let ticker = {
    ...
    neousdt: {open: null, high: null, low: null},
    apeusdt: {open: null, high: null, low: null},
    lunausdt: {open: null, high: null, low: null},
    trxusdt: {open: null, high: null, low: null},
    xmrusdt: {open: null, high: null, low: null},
    scusdt: {open: null, high: null, low: null},
    enjusdt: {open: null, high: null, low: null},
    etcusdt: {open: null, high: null, low: null},
    adausdt: {open: null, high: null, low: null},
    dashusdt: {open: null, high: null, low: null},
    shibusdt: {open: null, high: null, low: null},
};
...
// console.log('订阅 __keyspace@1__:* 成功');
// 订阅
...
async function depthHandle(symbol, data) {
    if (symbol === 'neousdt') {
        let priceOffset = 0;
        priceOffset = await redis.get('price_offset:neousdt');
...
async function tickerHandle(symbol, data) {
    if (symbol === 'neousdt') {
        let priceOffset = await redis.get('price_offset:neousdt');
